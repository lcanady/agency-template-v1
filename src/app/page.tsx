          ...
          <>
            ...
            <div className="absolute inset-0 -z-10">
              {site.hero.imageUrl ? (
                ...
                <div className="absolute inset-0 bg-gray-900" style={{ background: `linear-gradient(135deg, ${themeColor}22, #111827)` }} />
              )}
            ...
            <div className="max-w-7xl mx-auto px-6 w-full">
              <div className="max-w-3xl space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-5 pt-4">
                  <a 
                    href={`tel:${site.contact.phone}`}
                    className="px-10 py-5 rounded-2xl text-white font-bold text-xl hover:scale-[1.02] transition-all shadow-2xl text-center"
